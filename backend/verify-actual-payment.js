...
async function verifyActualPayment() {
  try {
    ...
    // The actual session ID from the database
    const sessionId = 'cs_test_a1i5BqCtJ29Dpjlvq2iZC7CDSxFpvnBbl043scsV9aOyaRQJvbFLtGpu4f';
    ...
    if (session.payment_status === 'paid' && booking.paymentStatus === 'pending') {
      ...
      console.log('   Booking status:', booking.paymentStatus);
    }
